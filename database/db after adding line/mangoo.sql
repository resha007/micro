...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 21, 2021 at 03:07 AM
...
DROP TABLE IF EXISTS `custmarried`;
...
DROP TABLE IF EXISTS `emplmarried`;
...
CREATE TABLE IF NOT EXISTS `employee` (
  ...
  `empl_type` varchar(10) COLLATE utf8_bin NOT NULL,
...
INSERT INTO `employee` (`empl_id`, `empl_no`, `empl_name`, `empl_dob`, `emplsex_id`, `emplmarried_id`, `empl_position`, `empl_type`, `empl_salary`, `empl_address`, `empl_phone`, `empl_email`, `empl_in`, `empl_out`, `empl_lastupd`, `empl_active`, `empl_pic`, `user_id`) VALUES
...
(10, '010', 'Judas Thaddaeus', -3600, 1, 2, '', 'Rider', 0, 'Capharnaum', '0123456', '', -3600, NULL, 1465480451, 0, NULL, 1),
(11, '011', 'Simon, the Zealot', -3600, 1, 1, '', '', 0, 'Canan', '0123456', '', -3600, NULL, 1458033133, 0, NULL, 1),
(12, '012', 'Judas Iscariot', -3600, 1, 3, 'Treasurer', 'Rider', 30, 'Nazareth', '0416468416', '', 537577200, 1410213600, 1458731879, 0, NULL, 1),
(13, '13', 'resh', 1638748800, 1, 1, 'asd', 'Rider', 2345, 'aaaa', '2232343', 'sfsae@gmail.com', 1640044800, NULL, 1640044800, 0, NULL, 1);
...
INSERT INTO `line` (`line_id`, `code`, `name`, `rider_id`, `opt_rider_id`, `status`) VALUES
(1, 'wdfwqf', 'fwefewf', 0, 0, 1),
(2, 'wdfwqf', 'fwefewf', 0, 0, 1),
(3, '1111', 'aaaaa', 0, 0, 1),
(4, '222', 'ssss', 0, 0, 2),
(5, '123', 'asd', 10, 12, 1);
...
(55, 1, 1639382904, 1639641394, 0),
(56, 1, 1639641394, 1639641434, 0),
(57, 1, 1639641434, 1639641434, 0),
(58, 1, 1639641434, 1639641451, 0),
(59, 1, 1639641451, 1639641467, 1),
(60, 1, 1639641485, 1639647510, 0),
(61, 1, 1639647510, 1639708101, 0),
(62, 1, 1639708101, 1640054204, 0),
(63, 1, 1640054204, NULL, 0);
...
DROP TABLE IF EXISTS `savbalance`;
